...
//
// Hover trails and click ripples are desktop-only. Idle auto-trails run on
// touch too; on phones the field is otherwise driven by programmatic ripples
// (the hero's slam landing).
//
